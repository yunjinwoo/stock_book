...
#[파이썬] 주식 현재가 조회
#http://money2.creontrade.com/e5/mboard/ptype_basic/plusPDS/DW_Basic_Read.aspx?boardseq=299&seq=41&page=1&searchString=&prd=a&lang=7&p=8833&v=8639&m=9505

# 연결 여부 체크
objCpCybos = win32com.client.Dispatch("CpUtil.CpCybos")
bConnect = objCpCybos.IsConnect
print(objCpCybos.IsConnect)
if (bConnect == 0):
